...
namespace UltimateProceduralPrimitives
{
  ...
  public struct CloudsParameters
  {
    public SurfaceType SurfaceType; public Direction Direction; public PivotPosition PivotPosition;
    public int MarchingCubeCells;
    public List<CloudSpheres> CloudSpheres;
    public double Roundness; // This is Offset. Make the mesh smoother, rounder, and bigger.

    public bool FlipNormals;
  }
  public struct CloudSpheres
  {
    public double RadiusOfSphere;
    public Vector3d PositionOfSphere;
    public double BlendWithNextSphere; // The last value in the list has no spheres to connect, so the value is ignored
